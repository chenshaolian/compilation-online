  ...
  test.onclick = function () {
    ...
    axios({
      ...
      if (output.code == 'Error') {
        document.getElementById('outputContainer').style.color = 'red';
      } else {
        document.getElementById('outputContainer').style.color = 'black';
      }
      document.getElementById('outputContainer').textContent = output.output
    });
  };
